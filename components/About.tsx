...
import { SiReact, SiNextdotjs, SiTypescript, SiLaravel, SiNodedotjs, SiTailwindcss, SiPostgresql, SiDocker, SiMysql, SiPhp, SiLinux, SiAndroid, SiSqlite, SiBootstrap, SiJavascript } from "react-icons/si";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm group hover:border-cyan-500/50 transition-colors flex flex-col md:flex-row gap-6 items-center md:items-start text-center md:text-left">
                <div className="p-4 rounded-xl bg-cyan-500/10 text-cyan-400 group-hover:bg-cyan-500 group-hover:text-black transition-colors shrink-0">
                  <FaGraduationCap size={32} />
                </div>
                <div>
                  <h3 className="font-bold text-white text-xl mb-1">Education</h3>
                  <p className="text-zinc-300 font-semibold text-lg">President University</p>
                  <p className="text-cyan-400 font-medium">Informatics Engineering</p>
                  <p className="text-zinc-500 text-sm mt-2 leading-relaxed">
                    Focusing on Software Engineering, Data Structures, and building scalable digital systems.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="p-8 rounded-3xl bg-gradient-to-b from-zinc-900 to-black border border-white/10 relative overflow-hidden group">
              ...
              <ul className="space-y-6">
                <li className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-bold">System Security</h4>
                    <p className="text-zinc-400 text-sm">Mengimplementasikan proteksi level tinggi pada aplikasi desktop dan web.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="mt-1 w-2 h-2 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.8)] shrink-0" />
                  <div>
                    <h4 className="text-white font-bold">Eco-Tech Solutions</h4>
                    <p className="text-zinc-400 text-sm">Membangun aplikasi yang memberikan dampak positif bagi lingkungan.</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="mt-1 w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)] shrink-0" />
                  <div>
                    <h4 className="text-white font-bold">Full Stack Logic</h4>
                    <p className="text-zinc-400 text-sm">Menghubungkan frontend yang responsif dengan backend yang efisien.</p>
                  </div>
                </li>
              </ul>

...
import { FADE_IN, FADE_IN_LEFT, FADE_IN_UP } from "@/constants/animations";
      ...
      >
        ...
        >
          ...
          <div className="relative z-20 px-4 mb-16">
            <motion.div {...FADE_IN} className="max-w-7xl mx-auto">
          ...
          <div className="max-w-7xl mx-auto px-4 mb-12">
            {isLoading ? (
              ...
              <>
                ...
                <motion.div {...FADE_IN_UP} className="mb-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-center bg-zinc-900/40 rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 border border-white/10 backdrop-blur-xl hover:border-cyan-500/30 transition-colors duration-500">
                      ...
                      <div className="space-y-4 md:space-y-6">
                        <div className="flex items-center gap-3">
                          <div
                            className={`p-2 md:p-3 rounded-xl bg-gradient-to-r ${displayProjects[0]?.gradient}`}
                          >
                            {displayProjects[0] &&
                              React.createElement(displayProjects[0].icon, {
                        ...
                        <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                          {displayProjects[0]?.longDescription ||
                            displayProjects[0]?.description}
                        </p>

                        <div className="flex flex-wrap gap-2">
                          {displayProjects[0]?.tags
                            .slice(0, 5)
                            .map((tag, i) => (
                              <span
                                key={i}
                                className="px-2.5 md:px-3 py-1 bg-white/10 border border-white/20 rounded-full text-xs md:text-sm text-gray-300"
                              >
                                {tag}
                              </span>
                            ))}
                        ...
                        >
                          <InteractiveHoverButton className="bg-transparent border-white/20 text-white hover:bg-white/10">
                            View Details

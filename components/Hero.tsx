...
export default function Hero() {
  ...
  return (
    <section ref={containerRef} id="home" className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-transparent pt-24 pb-12">
       ...
       <div className="container mx-auto px-4 relative z-0 w-full flex flex-col items-center justify-center text-center gap-6 h-full">
          ...
          >
              ...
              <h1 className="font-pixel text-[12vw] md:text-[14vw] font-black text-white/5 leading-none tracking-tighter absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap select-none pointer-events-none blur-sm">
                CYBER DEV
              </h1>
              ...
              <div className="relative z-10 space-y-4">
                  ...
                  <h2 className="font-pixel text-5xl md:text-7xl font-bold text-white tracking-tight">
                    FULL STACK & <br/>
          ...
          <motion.div
            ...
            className="relative w-72 h-72 md:w-[500px] md:h-[500px] my-2"
            style={{
          ...
          >
              <p className="text-lg md:text-xl text-zinc-400 mb-6 leading-relaxed font-light">
              ...
              <div className="flex gap-4 mt-2">
                <MagneticButton>
                  <a href="#projects" className="px-8 py-3 bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 border border-cyan-500/50 rounded-full transition-all backdrop-blur-sm font-medium tracking-wide shadow-[0_0_15px_rgba(34,211,238,0.2)] hover:shadow-[0_0_25px_rgba(34,211,238,0.4)]">
                    View My Work
                  </a>
                </MagneticButton>
              </div>

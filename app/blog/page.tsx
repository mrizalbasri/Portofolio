            ...
            {blogPosts.map((post, index) => (
              ...
              >
                {viewMode === "grid" ? (
                  ...
                  <BlogPostListItem post={post} index={index} />
                )}
              </Link>
            ))}
          </div>
      ...
      <div className="relative h-48 w-full overflow-hidden bg-zinc-800">
        {displayImage ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-zinc-800 to-zinc-950 flex items-center justify-center">
            <span className="text-zinc-700 font-bold text-4xl opacity-20">
              No Image
            </span>
          </div>
        )}
    ...
    >
      ...
      <div className="w-full md:w-64 h-48 md:h-40 flex-shrink-0 rounded-xl overflow-hidden bg-zinc-800 relative">
        {post.image ? (
          ...
          <div className="w-full h-full bg-zinc-800 flex items-center justify-center text-zinc-700 font-bold">
            No Image
          </div>
        )}
      </div>
